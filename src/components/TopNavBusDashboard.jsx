...
export const TopNavBusDashboard = (props) => 
{
    ...
    const NotiIcon = (props) => ( <Icon {...props} name='bell-outline' fill='#8C89B7' style={{ width: 32, height: 32, }} /> );
    const AccountIcon = (props) => ( <Icon {...props} name='person' fill='#8C89B7' style={{ width: 32, height: 32, }} /> );
    ...
    return (
        <TopNavigation
        title={(evaProps) => <Layout style={{ flexDirection: 'row' }}><Text {...evaProps} style={{color: '#131141', fontSize: 20}}>Hello, </Text><Text {...evaProps} style={{color: '#131141', fontSize: 20, fontWeight: 'bold'}}>{props.title}</Text></Layout>}
        alignment="start"
