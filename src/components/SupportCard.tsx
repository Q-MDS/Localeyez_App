			...
			<Layout style={{ flexDirection: 'row', alignItems: 'flex-start', width: '100%', backgroundColor: bg }} >
				...
				{props.record.contact_type === '0' ? (
					<Layout style={{ flexDirection: 'column', flex: 1, backgroundColor: bg }}>
						<TextTwo title={props.record.contact.company_name} fontweight="bold" fontsize={16} width='100%' />
						<TextTwo title={`Message: ${props.record.mesage_desc.substring(0, 70) + '...'}`} />
					</Layout>

				) : (
					<Layout style={{ flexDirection: 'column', flex: 1, backgroundColor: bg }}>
						<TextTwo title={props.record.contact.first_name} fontweight="bold" fontsize={16} width='100%' />
						...
						<TextTwo title={`Message: ${props.record.mesage_desc && props.record.mesage_desc.length > 70 ? props.record.mesage_desc.substring(0, 70) + '...' : props.record.mesage_desc}`} />
					</Layout>
