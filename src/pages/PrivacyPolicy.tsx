...
import { Layout, Card, Divider } from "@ui-kitten/components";
		...
		<SafeAreaView style={{ flex: 1 }}>
			...
			<Layout style={[MainStyles.layout_container, { paddingTop: 0, paddingStart: 15, paddingEnd: 15, backgroundColor: '#fff'}]}>
				...
				<View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: 5 }}>
					<Text style={{ fontSize: 20, fontWeight: 'bold', color: '#612bc1', width: '100%' }}>Privacy Policy</Text>
				</View>
				...
				<ScrollView style={{ backgroundColor: 'white', flex: 1, width: '100%'  }}>
					<Layout style={[MainStyles.layout_container, {flex: 1, width: '100%'} ]}>
						<TextTwo title="Privacy Policy for Localeyez" fontsize={20} width="100%" status="primary" mb={10} />
