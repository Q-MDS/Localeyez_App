      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ScrollView>
            <Layout style={[MainStyles.layout_container, {backgroundColor: '#fff'}]}>
                ...
                <InputLabel label="Promotion Title" name="promoTitle" value={state.promoTitle} onChange={handleInputChange} placeholder="Cake Sale!" />
                <View style={{ marginTop: 15 }} />
                <InputMultiline label="Promotion Caption" name="promoCaption" value={state.promoCaption} onChange={handleInputChange} placeholder="Write a caption" />
                <View style={{ marginTop: 15 }} />
                <InputMultiline label="Promotion Description" name="promoDesc" value={state.promoDesc} onChange={handleInputChange} placeholder="Write a description" />
                <View style={{ marginTop: 15 }} />
                <InputLabel label="Price" name="promoPrice" value={state.promoPrice} onChange={handleInputChange} placeholder="$200" />
                <View style={{ marginTop: 15 }} />
                <InputLabel label="Sale Item (Optional)" name="promoSiOp" value={state.promoSiOp} onChange={handleInputChange} placeholder="$300" />
                <InputLabel mt={5} name="promoSiMp" value={state.promoSiMp} onChange={handleInputChange} placeholder="$200" />
                <View style={{ marginTop: 15 }} />
                ...
                <View style={{ marginTop: 15 }} />
                <InputLabel label="Promotion Location (Optional)" name="promoLocAdd1" value={state.promoLocAdd1} onChange={handleInputChange} placeholder="18 Street" />
                <View style={{ marginTop: 5 }} />
                <InputLabel name="promoLocAdd2" value={state.promoLocAdd2} onChange={handleInputChange} placeholder="Suburb" />
                <View style={{ marginTop: 5 }} />
                <InputLabel name="promoLocCity" value={state.promoLocCity} onChange={handleInputChange} placeholder="Cape Town" />
                <View style={{ marginTop: 5 }} />
                <InputLabel name="promoLocProvince" value={state.promoLocProvince} onChange={handleInputChange}placeholder="Western Cape" />
                <View style={{ marginTop: 5 }} />
                <InputLabel name="promoLocZipCode" value={state.promoLocZipCode} onChange={handleInputChange} placeholder="9901" />
