...
const Education = (props) => 
{
	...
	const handleCategorySearch = (category) => 
	{
		...
		{
			props.navigation.navigate('BrowseSearch', {searchType: 0, searchSector: "Education & Employment", category:category, categoryItem: category});
			return;
		} 
		...
		{
			props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Education & Employment", category: "employment", categoryItem: "employment"});
			return;
		}
	}
	...
	const handleItemSearch = (category, categoryItem) => 
	{
		...
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Education & Employment", category: category, categoryItem: categoryItem});
	}
            ...
            <ScrollView>
                <Layout style={[MainStyles.layout_container, { paddingTop: 0, paddingStart: 15, paddingEnd: 15, backgroundColor: '#fff'}]}>
					...
					<View style={{ marginBottom: 20 }}>
						<Image source={require('../../assets/images/cat_education.png')} style={{ height: 120, objectFit: 'contain', borderRadius: 10, alignSelf: 'center', marginTop: 10 }} />
