			...
			<ScrollView style={{flex: 1, backgroundColor: 'white'}}>
				<Layout style={[MainStyles.column_container, { backgroundColor: '#ffffff', paddingTop: 30, paddingBottom: 30}]}>
					...
					<Card style={{marginBottom:10}}>
						<Text style={MainStyles.title_a14}>Option for paid membership subscription with further discounts and benefits on offer</Text>
					</Card>
					<Card style={{marginBottom:10}}>
						<Text style={MainStyles.title_a14}>Notifications personally tailored to your interests</Text>
					</Card>
					<Card style={{marginBottom:10}}>
