...
const SubCharity = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Community", category: "community", categoryItem: "Children"});
	}

	const handleSearchOldAge = () => 
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Community", category: "community", categoryItem: "Old Age Pensioners"});
	}

	const handleSearchProjects = () => 
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Community", category: "community", categoryItem: "Community Projects"});
	}
	...
	const handleSearchConservation = () => 
	{
		...
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Community", category: "community", categoryItem: "Conservation"});
	}
