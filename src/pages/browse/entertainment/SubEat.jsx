...
const SubEat = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Restaurants"});
	}
	
	const handelSearchBars = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Bars"});
	}

	const handelSearchClubs = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Clubs"});
	}

	const handelSearchCoffee = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Coffee Shops"});
	}
	
	const handelSearchTakeaways = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Takeaways"});
	}

	const handelSearchBakeries = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Bakeries and Patisseries"});
	}

	const handelSearchSpeciality = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Speciality foods"});
	}

	const handelSearchCatering = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Entertainment", category: "eat", categoryItem: "Catering and ready meals"});
	}
