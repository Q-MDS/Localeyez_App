...
const Home = (props) => 
{
	const handelGotoEat = () =>
	{
		props.navigation.navigate('BrowseEntertainmentEat');
	}
	const handelGotoActivities = () =>
	{
		props.navigation.navigate('BrowseEntertainmentActivities');
	}
	const handelGotoEvents = () =>
	{
		props.navigation.navigate('BrowseEntertainmentEvents');
	}
