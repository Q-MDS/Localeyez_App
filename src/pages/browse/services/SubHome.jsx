...
const SubHome = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Services", category: "serHome", categoryItem: "serHome"});
	}

	const handelSearchBuilding = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Building"});
	}

	const handelSearchInteriors = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Interiors"});
	}

	const handelSearchPlumbing = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Plumbing"});
	}

	const handelSearchelectrical = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Electrical"});
	}
	
	const handelSearchPainting = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Painting"});
	}

	const handelSearchLandscaping = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Landscaping"});
	}

	const handelSearchCleaning = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Cleaning"});
	}

	const handelSearchPest = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Pest Control"});
	}

	const handelSearchVet = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serHome", categoryItem: "Veterinary and Pet parlours"});
	}
