...
const SubFinancial = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Services", category: "serFin", categoryItem: "serFin"});
	}
  
	const handelSearchBanks = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serFin", categoryItem: "Banks"});
	}

	const handelSearchBureau = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serFin", categoryItem: "Bureau De change"});
	}

	const handelSearchInsurance = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serFin", categoryItem: "Insurance"});
	}

	const handelsearchAccountants = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serFin", categoryItem: "Accountants"});
	}

	const handelSearchFinManagement = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serFin", categoryItem: "Financial Management"});
	}
