...
const Home = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseServicesHome');
	}

	const handelGotoSelfCare = () =>
	{
		props.navigation.navigate('BrowseServicesSelfCare');
	}

	const handelGotoFinancial = () =>
	{
		props.navigation.navigate('BrowseServicesFinancial');
	}

	const handelGotoPublic = () =>
	{
		props.navigation.navigate('BrowseServicesPublic');
	}

	const handelSearchLegal = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Services", category: "servicesOpt1", categoryItem: "servicesOpt1"});
	}
