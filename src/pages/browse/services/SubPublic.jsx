...
const SubPublic = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Services", category: "serPub", categoryItem: "serPub"});
	}

	const handelSearchWater = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serPub", categoryItem: "Water"});
	}

	const handelSearchEletricity = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serPub", categoryItem: "Electricity"});
	}

	const handelSearchRoads = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serPub", categoryItem: "Roads"});
	}

	const handelsearchPolice = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serPub", categoryItem: "Police"});
	}

	const handelSearchFire = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serPub", categoryItem: "Fire department"});
	}

	const handelSearchAccident = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Services", category: "serPub", categoryItem: "Accident and Emergency"});
	}
