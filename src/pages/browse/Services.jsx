...
const Services = (props) => 
{
	...
	const handleCategorySearch = (category) => 
	{
		...
		{
			props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Shopping", category: "serHome", categoryItem: "serHome"});
			return;
		}
		else if (category === "Self-care")
		{
			props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Shopping", category: "serSelf", categoryItem: "serSelf"});
			return;
		}
		else if (category === "Financial")
		{
			props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Shopping", category: "serFin", categoryItem: "serFin"});
			return;
		}
		else if (category === "Public Services Contacts")
		{
			props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Shopping", category: "serPub", categoryItem: "serPub"});
			return;
		}
		else if (category === "Legal")
		{
			props.navigation.navigate('BrowseSearch', {searchType: 1, searchSector: "Shopping", category: "servicesOpt1", categoryItem: "servicesOpt1"});
			return;
		}
	}
            ...
            <ScrollView>
                <Layout style={[MainStyles.layout_container, { paddingTop: 0, paddingStart: 15, paddingEnd: 15, backgroundColor: '#fff'}]}>
					...
					<View style={{ marginBottom: 20 }}>
						<Image source={require('../../assets/images/cat_services.png')} style={{ height: 120, objectFit: 'contain', borderRadius: 10, alignSelf: 'center', marginTop: 10 }} />
