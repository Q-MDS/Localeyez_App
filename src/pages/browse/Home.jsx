        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
			...
			{/* <ScrollView> */}
                <Layout style={[MainStyles.layout_container, {backgroundColor: '#fafafa', paddingStart: 20, paddingEnd: 20}]}>
                    <Layout style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', marginTop: 10, flex: 1 }}>
					...
					<TouchableOpacity onPress={handleReadMore} style={{ width: '100%' }}>
						<Text style={{ fontSize: 15, fontWeight: '500', textAlign: 'center', backgroundColor: '#612bc1', color: '#fff', padding:10, borderRadius: 20, marginTop: 20, borderTopColor: '#deded7', borderTopWidth: 1, borderBottomColor: '#deded7', borderBottomWidth: 1 }}>Read more about the benfits of signing up</Text>
					</TouchableOpacity>
                </Layout>
				{/* </ScrollView> */}
