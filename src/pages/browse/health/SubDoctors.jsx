...
const SubDoctors = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "General Practitioners"});
	}

	const handelSearchPhysicians = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Physicians"});
	}

	const handelSearchChiro = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Chiropractors"});
	}

	const handelSearchSurgeons = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Surgeons"});
	}

	const handelSearchDental = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Dental"});
	}

	const handelSearchHomeo = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Homeopathic"});
	}

	const handelSearchMental = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Mental Health"});
	}

	const handelSearchPeadiatric = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Peadiatric"});
	}

	const handelSearchOther = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "doctor", categoryItem: "Other Specialists"});
	}
