...
const SubSports = (props) => 
{
	...
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "sport", categoryItem: "Gyms"});
	}

	const handelSearchClubs = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "sport", categoryItem: "Sports Clubs"});
	}

	const handelSearchSpas = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "sport", categoryItem: "Spa’s"});
	}

	const handelSearchOutdoor = () =>
	{
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Health & Wellness", category: "sport", categoryItem: "Outdoor activities"});
	}
