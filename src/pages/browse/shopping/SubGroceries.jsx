...
const SubGroceries = (props) => 
{
	...
	const handelSearchFood = () =>
	{
		...
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Shopping", category: "groceries", categoryItem: "Food & Beverage"});
	}

	const handelSearchMarkets = () =>
	{
		console.log('Search Markets');
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Shopping", category: "groceries", categoryItem: "Local Markets & homemade goods"});
	}

	const handelSearchHousehold = () =>
	{
		console.log('Search Household');
		props.navigation.navigate('BrowseSearch', {searchType: 2, searchSector: "Shopping", category: "groceries", categoryItem: "Household goods"});
	}
