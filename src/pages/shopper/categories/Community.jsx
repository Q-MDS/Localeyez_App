...
const Community = (props) => 
{
	...
	const handleCategorySearch = (category) => 
	{
		...
		{
			props.navigation.navigate('CatSearch', {searchType: 0, searchSector: "Community", category:category, categoryItem: category});
			return;
		} 
		...
		{
			props.navigation.navigate('CatSearch', {searchType: 1, searchSector: "Community", category: "community", categoryItem: "community"});
			return;
		}
	}
	...
	const handleItemSearch = (category, categoryItem) => 
	{
		...
		props.navigation.navigate('CatSearch', {searchType: 2, searchSector: "Community", category: "community", categoryItem: categoryItem});
	}
