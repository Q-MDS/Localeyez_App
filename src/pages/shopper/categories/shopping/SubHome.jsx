...
const SubHome = (props) => 
{
	const handleSearchCategory = () =>
	{
		...
		props.navigation.navigate('CatSearch', {searchType: 1, searchSector: "Shopping", category: "home", categoryItem: "home"});
	}

	const handelSearchFurniture = () =>
	{
		console.log('Search Furniture');
		props.navigation.navigate('CatSearch', {searchType: 2, searchSector: "Shopping", category: "home", categoryItem: "Furniture"});
	}

	const handelSearchFixtures = () =>
	{
		console.log('Search Fixtures');
		props.navigation.navigate('CatSearch', {searchType: 2, searchSector: "Shopping", category: "home", categoryItem: "Fixtures and Fittings"});
	}

	const handelSearchHomeware = () =>
	{
		console.log('Search Homeware');
		props.navigation.navigate('CatSearch', {searchType: 2, searchSector: "Shopping", category: "home", categoryItem: "Homeware and Décor"});
	}

	const handelSearchElectronics = () =>
	{
		console.log('Search Electronics');
		props.navigation.navigate('CatSearch', {searchType: 2, searchSector: "Shopping", category: "home", categoryItem: "Electronics and appliances"});
	}
