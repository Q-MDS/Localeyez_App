...
// const APP_STORE_SECRET = Config.APP_STORE_SECRET;
...
console.log('APP_STORE_SECRET 2', APP_STORE_SECRET);
...
const Subscriptions = ({ navigation }) => {
  ...
  useEffect(() => {
    console.log('APP_STORE_SECRET 1', APP_STORE_SECRET);
  ...
  useEffect(() => {
    console.log('CONNECTED: ', subscriptions);
    handleGetSubscriptions();
  }, [connected]);

  // useEffect(() => {
  //   console.log('Get Subscriptions'); ddd
  //   handleGetSubscriptions();
  // }, []);
    ...
    <SafeAreaView>
      <ScrollView>
        <View style={{ padding: 10 }}>
          ...
          <View style={{ marginTop: 10,  borderColor: 'red', borderWidth: 1, height: 300 }}>
