...
const MonthlyStepTwo = (props) => 
{
    const handlePlaceOrder = () => 
    {
        props.navigation.navigate("SignupUserMonthlyThree");
    }

    return (
        <SafeAreaView style={{ flex: 1 }}>
            <TopNavArrowTitle title="" alignment="start" navigation={props.navigation} />
            <Layout style={{ flexDirection: 'column', flex: 1, justifyContent: "center", alignItems: "center", padding: 25 }}>
                ...
                <View style={{  flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderColor: 'white', borderWidth: 1, width: '100%' }} >
                    ...
                    <ButtonPrimary name="Place Order" marginTop={25} width="100%" onpress={handlePlaceOrder} />
                </View>
