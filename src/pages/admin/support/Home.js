...
import { getSupportMessages } from '../../../services/api_admin';
...
const Home = (props) => 
{
	...
	const fetchRecords = async () => 
	{
		...
		const res = await getSupportMessages(token, apiData);
	...
	{
		console.log('View support ticket');
		props.navigation.navigate('AdminSupportView', { record: record });
	}
